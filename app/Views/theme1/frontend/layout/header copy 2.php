...
<nav class="navbar navbar-expand-md navbar-light bg-light p-0 sticky-top " style="top: -1px;">
    <div class="container-fluid header-padding">
        <a class="navbar-brand" href="#">
            <img class="logo horizontal-logo assets-img-header-logo-png" src="<?= base_url(env('SEO_SUBPATH').'/uploads/img/business_logo/').'/'.$user_details['business_logo']; ?>" alt="forecastr logo" width="100px" height="100px">
        </a>
                ...
                <?php
                    foreach ($menu_lists as $menu_list) {
                        ...
                        <li class="nav-item <?= $cls;?>m-0">                        
                            <a class="nav-link <?= $toggle_cls;?> fs-6" 
